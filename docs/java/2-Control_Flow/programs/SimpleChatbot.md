...
public class SimpleChatbot {
    ...
    public static void main(String[] args) {
        ...
        switch(grade) {
            case 9:
                System.out.println("You must be a freshman! Welcome to Lenape!");
            break;

            case 10:
                System.out.println("You must be a sophomore! Welcome back to Lenape!");
            break;

            case 11:
                System.out.println("You must be a junior! Welcome back to Lenape!");
            break;
            
            case 12:
                System.out.println("You must be a senior! Welcome back to Lenape!");
            break;
